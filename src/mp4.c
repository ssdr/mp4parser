...
#define msg_Warn(fmt, ...) do{} while(0)
#define msg_Err(fmt, ...) do{} while(0)
...
// #ifdef MP4_VERBOSE
//     msg_Dbg( p_stream, "read box: \"trkn\" number=%i", p_trkn->track_number );
// #endif
...
// #ifdef MP4_VERBOSE
//        msg_Dbg( p_stream, "read box: \"trkn\" total=%i", p_trkn->track_total );
// #endif
